...
public class ToolUtil {
  ...
  /**
   * Keeps only the tools whose MCP server name and tool name match the given hints. A null/blank
   * hint means "match everything", same idea as the global {@link McpServerToolFilter}, but applied
   * per request.
   */
  public static ToolCallback[] selectToolsFor(List<McpSyncClient> mcpSyncClients,
