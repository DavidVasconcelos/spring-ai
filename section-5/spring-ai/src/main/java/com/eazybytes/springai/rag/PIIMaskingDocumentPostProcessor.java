...
/**
 * Masks sensitive information (e.g., emails, phone numbers) in document content to ensure privacy
 * and compliance. Uses regex patterns to identify and redact PII.
 */
public class PIIMaskingDocumentPostProcessor implements DocumentPostProcessor {

  private static final Logger logger = LoggerFactory.getLogger(
      PIIMaskingDocumentPostProcessor.class);
